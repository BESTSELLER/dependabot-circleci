...
import (
	...
	"github.com/BESTSELLER/dependabot-circleci/cmd"
...
func main() {
	...
	if *controllerFlag {
		log.Info().Msg("webhookEnabled false, workerEnabled false, controllerEnabled true")
		cmd.ControllerStart()
		return
	}

	api.SetupRouter(*webhookFlag, *workerFlag)
}
